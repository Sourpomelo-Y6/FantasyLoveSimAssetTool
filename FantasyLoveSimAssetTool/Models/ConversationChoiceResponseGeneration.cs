...
{
    public sealed class ConversationChoiceResponseGenerationContext
    {
        ...
        public IReadOnlyCollection<string> ExistingResponses { get; set; } = new List<string>();
    }

    public sealed class ConversationChoiceResponseGenerationResult
    {
